        ...
        while True:
            ...
            while True:
                ...
                if data["playing"]:
                    ...
                    ai_k += (np.random.random(ai_k.shape) - 0.5) * random_threthold
                    for i in ai_m:
                        i += (np.random.random(i.shape) - 0.5) * random_threthold
                    for i in ai_mem:
                        i += (np.random.random(i.shape) - 0.5) * random_threthold
                    ai_chat += (np.random.random(ai_chat.shape) - 0.5) * random_threthold
                    AI_USING = False
                    keys_str = "\r\033[37m"
