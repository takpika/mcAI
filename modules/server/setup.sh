...
installPackages() {
    ...
    DEBIAN_FRONTEND=noninteractive sudo apt install openjdk-17-jdk python3 python-is-python3 python3-pip python3.11-venv cifs-utils screen inetutils-ping watchdog curl -y > /dev/null
